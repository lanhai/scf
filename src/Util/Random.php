...
class Random
{
    static function character($length = 6, $alphabet = 'AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz0123456789'): string {
        mt_srand();
        // 重复字母表以防止生成长度溢出字母表长度
    ...
    static function number($length = 6): string {
     ...
     * @return string
     */
    static function makeUUIDV4(): string {
        mt_srand();
