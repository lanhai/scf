...
namespace Scf\Server\SocketIO\Engine\Transport;

use Scf\Server\SocketIO\Engine\Payload\HttpResponsePayload;
use Scf\Server\SocketIO\Engine\Payload\PollingPayload;
use Scf\Server\SocketIO\Enum\Message\PacketTypeEnum;
use Scf\Server\SocketIO\Enum\Message\TypeEnum;
use Scf\Server\SocketIO\Parser\Polling\Packet;
use Scf\Server\SocketIO\Parser\Polling\Payload;
use Scf\Server\SocketIO\Storage\Table\NamespaceSessionTable;
use Scf\Server\SocketIO\Storage\Table\SessionListenerTable;
use Scf\Server\SocketIO\Storage\Table\SessionNamespaceTable;

/**
 * Class Xhr
 *
 * @package Scf\Server\SocketIO\Engine\Transport
 */
