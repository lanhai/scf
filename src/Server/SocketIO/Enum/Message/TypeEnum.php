...
namespace Scf\Server\SocketIO\Enum\Message;

use Scf\Server\SocketIO\Enum\BaseEnum;
 ...
 * EngineIO Packet
 *
 * @package Scf\Server\SocketIO\Enum\Message
 */
class TypeEnum extends BaseEnum
{
    ...
    /**
     * Receive the close of this transport but does not shutdown the connection itself.
     *
     * @message("close")
     */
