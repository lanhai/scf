...
class Date {
     ...
     * @return array
     */
    public static function calendar($start, $end, $format = "Ymd", $weekdayFormat = 1) {
     ...
     * @return array
     */
    public static function timeline($start, $end, $unit = 'hour', $format = "Y-m-d H:i:s", $weekdayFormat = 1) {
     ...
     * @return array
     */
    public static function pastMonths($month = 1, $format = "Y-m", $calendar = false) {
        $list = [];
        $dayList = [];
        for ($i = $month; $i > 0; $i--) {
