...
class Assigner {
    ...
    protected function all(&...$vars): array {
        ...
        foreach ($this->_config as $key => $default) {
            ...
            if ($default instanceof Verify) {
                $data[$key] = Request::instance()->_all($key, Request::REQUIRED, $default);
            } else {
    ...
    protected function get(&...$vars): array {
        ...
        foreach ($this->_config as $key => $default) {
            ...
            if ($default instanceof Verify) {
                $data[$key] = Request::instance()->_get($key, Request::REQUIRED, $default);
            } else {
    ...
    protected function post(&...$vars): array {
        ...
        foreach ($this->_config as $key => $default) {
            ...
            if ($default instanceof Verify) {
                $data[$key] = Request::instance()->_post($key, Request::REQUIRED, $default);
            } else {
